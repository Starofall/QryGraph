( function (Dataflow) {
    ...
    Edge.Model = Backbone.Model.extend({
        ...
        initialize: function () {
            ...
            if (preview) {
                ...
                try {
                    ...
                    //notify
                    sourceNode.trigger("nodeChanged");
                    targetNode.trigger("nodeChanged");

                } catch (e) {
                    console.log("node or port not found for edge", e);
                }
                // console.log(this)
        ...
        send: function (value) {
            this.target.parentNode.recieve(this.target.id, value, this.target.id);
        },
    ...
    window.SimpleEdge = Edge.Model;
    window.SimpleEdge.collection = Edge.Collection;
